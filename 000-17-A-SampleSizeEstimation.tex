...
- The product of the quantile and the standard error gives us the width of the confidence interval.
- The width of the confidence interval is known as the **_margin of error_**:  
  \[
  \text{Margin of Error} = \text{Quantile} \times \text{Standard Error}
  \]
- The margin of error provides an indication of how uncertain we are about the unknown population parameter.
- A very wide interval may suggest that more data should be collected before drawing any firm conclusions about the parameter.
- The only way to control the margin of error is to adjust the sample size accordingly.
- By choosing an appropriate sample size, it is possible to ensure that the margin of error does not exceed a specified threshold.
...
- The standard deviation of the self-study group is assumed to be the same as the overall population of candidates, i.e., 21.2 points.
